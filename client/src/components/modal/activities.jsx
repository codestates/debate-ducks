...
export default function ActivitiesModal({ content }) {
  // axios.get('/use/modal/:userId')

  const itemListStyle = "text-14 mb-12";
  const navigate = useNavigate();
  return (
    <div className="w-max pt-20 pb-12 px-20 m-2 border border-solid border-ducks-orange-ff9425 font-poppins rounded-12">
...
ActivitiesModal.propTypes = { content: PropTypes.object };
